        ...
        <div id="projects" className="flex flex-col gap-20 mt-16 justify-start items-center">
            ...
            <div className="grid grid-cols-1  md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-10 gap-y-10">
                ...
                <ProjectCard
                    ...
                    githubLink={"https://github.com/Olamilekan-hub/Discord-Clone"}
                />
                ...
                <ProjectCard
                    ...
                    githubLink={"https://ai-saas-three-zeta.vercel.app/"}
                />
                ...
                <ProjectCard
                    ...
                    githubLink={"https://github.com/Olamilekan-hub/Twitter-X-Clone"}
                />
                ...
                <ProjectCard
                    ...
                    githubLink={"https://github.com/Olamilekan-hub/MERN-BLOG-beginner-friendly"}
                />
                ...
                <ProjectCard
                    ...
                    githubLink={"https://real-estate-h25m.onrender.com/"}
                />
                ...
                <ProjectCard
                    ...
                    githubLink={"https://gleam-google-clone.vercel.app/"}
                />
